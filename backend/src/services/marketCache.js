...
const CROP_ALIAS_GROUPS = {
  ...
  bajra: ['bajra', 'bajrapearlmilletcumbu', 'pearlmillet', 'bajari', 'bajrapearlmillet'],
  tur: ['tur', 'redgramarharturwhole', 'arhar', 'pigeonpea', 'turdal', 'toordal', 'turdalpigeonpea', 'redgramsplitarhardalturdal', 'redgramarhar', 'redgramtur'],
  chilli: ['chilli', 'greenchilli', 'chili', 'mirchi', 'redchilli'],
  cotton: ['cotton', 'cottonraw', 'kapas'],
  sugarcane: ['sugarcane', 'ganna'],
  ginger: ['ginger', 'gingergreen', 'greenginger'],
  blackgram: ['blackgram', 'blackgramurdbeanswhole', 'urd', 'urdal', 'blackgramurad', 'blackgramdalurddal'],
  greengram: ['greengram', 'greengrammoongwhole', 'moong', 'moongdal', 'greengrammoong', 'greengramdalmoongdal'],
  bengalgram: ['bengalgram', 'bengalgramgramwhole', 'chana', 'chanadal', 'bengalgramchana', 'bengalgramdalchanadal'],
