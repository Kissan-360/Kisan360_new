...
const RegisterPage = () => {
  ...
  // Same one-tap demo entry as Login — a judge landing here from
  // "Create one" must never lose the demo path.
  const DEMO_ROLES = [
    ...
    <PageTransition className="min-h-screen bg-gradient-to-br from-stone-50 via-emerald-50/30 to-stone-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          {/* Language chips — a wrong-locale judge must be able to switch
        ...
        <Card className="p-8">
          ...
          {/* Demo sign-in divider — mirrors Login so the demo path survives here */}
          <div className="mt-6">
